                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group mb-3">
                                                <select class="form-control" name="newSystemApplicationStatus" id="newSystemApplicationStatus" required>
                                                    <option selected="selected" disabled>Choose one</option>
                                                    <option value="TRUE" disabled>Open</option>
                                                    <option value="FALSE" disabled>Close</option>
                                                </select>
